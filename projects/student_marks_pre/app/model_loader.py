# import joblib
# import pandas as pd
# linear_regression_model = joblib.load('../models/linear_regression_pipeline.pkl')
# decision_tree_model = joblib.load('../models/decision_tree_pipeline.pkl')
# random_forest_model = joblib.load('../models/random_forest_pipeline.pkl')
...
def load_models():
    return {
        "lr": joblib.load("models/linear_regression_pipeline.pkl"),
        "dt": joblib.load("models/decision_tree_pipeline.pkl"),
